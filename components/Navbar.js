...
const Navbar = (props) => {
    ...
    return (
        <div className={styles.navbar}>
            ...
            <form ref={el => {form = el}} onSubmit={e => formSub(e)} className={styles.input}>
            ...
            <div className={styles.right}>
                {(!deployed)?<button onClick={() => {deployResearch()}} className={styles.buttonSearch}><img height={50} src={'/img/svg/search-outline.svg'} alt="research img" /></button>: <button ref={el => {closeBtn = el}} className={styles.closeButton} onClick={() => {closeResearch()}}>&times;</button>}
