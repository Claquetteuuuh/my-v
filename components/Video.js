...
const Video = (props) => {
    return (
        <div className={styles.Video}>
            <Link href={`/view?id=${props.id}`}><div className={styles.miniature}><img src={props.miniature} loading={props.loading} alt={`miniature of ${props.title}`} width='390' height="218" /></div></Link>
